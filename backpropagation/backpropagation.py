...
for e in range(epochs):
    ...
    for x, y in zip(features.values, targets):
        ...
        output_error = sigmoid_derivative(output) * error

        # TODO: propagate errors to hidden layer
        hidden_error = sigmoid_derivative(hidden_activations) * output_error * weights_hidden_output

        # TODO: Update the change in weights
        del_w_hidden_output += output_error * hidden_activations
        del_w_input_hidden += hidden_error * sigmoid_derivative(hidden_activations)
